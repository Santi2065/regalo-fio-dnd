...
const SAMPLE_ASSETS: &[SampleAsset] = &[
    SampleAsset {
        bundle_path: "../assets/audio/tavern_ambient.mp3",
        display_name: "Taberna",
        asset_type: "audio",
        stable_id: "smp-aud-tavern",
    },
    SampleAsset {
        bundle_path: "../assets/audio/forest_ambient.mp3",
        display_name: "Bosque",
        asset_type: "audio",
        stable_id: "smp-aud-forest",
    },
    SampleAsset {
        bundle_path: "../assets/audio/dungeon_ambient.mp3",
        display_name: "Dungeon",
        asset_type: "audio",
        stable_id: "smp-aud-dungeon",
    },
    SampleAsset {
        bundle_path: "../assets/audio/battle_sfx.mp3",
        display_name: "Combate (SFX)",
        asset_type: "audio",
        stable_id: "smp-aud-battle",
    },
    SampleAsset {
        bundle_path: "../assets/audio/sword_clash.mp3",
        display_name: "Espadazo",
        asset_type: "audio",
        stable_id: "smp-aud-sword",
    },
    SampleAsset {
        bundle_path: "../assets/audio/magic_spell.mp3",
        display_name: "Hechizo",
        asset_type: "audio",
        stable_id: "smp-aud-magic",
    },
    SampleAsset {
        bundle_path: "../assets/audio/door_creak.mp3",
        display_name: "Puerta",
        asset_type: "audio",
        stable_id: "smp-aud-door",
    },
    SampleAsset {
        bundle_path: "../assets/images/castle.jpg",
        display_name: "Castillo",
        asset_type: "image",
        stable_id: "smp-img-castle",
    },
    SampleAsset {
        bundle_path: "../assets/images/dungeon_map.jpg",
        display_name: "Mapa de Mazmorra",
        asset_type: "image",
        stable_id: "smp-img-map",
    },
    SampleAsset {
        bundle_path: "../assets/images/dragon.jpg",
        display_name: "Dragón",
        asset_type: "image",
        stable_id: "smp-img-dragon",
    },
    SampleAsset {
        bundle_path: "../assets/images/treasure.jpg",
        display_name: "Tesoro",
        asset_type: "image",
